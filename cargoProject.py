        ...
        if result==None:
            ...
            def main():
                ...
                def cargo():
                    ...
                    def c_des():
                        root4.withdraw()
                    button = Button(root4,text="BACK",command=c_des,width=20,height=3,font=("verdana", 10),fg=fb_color,bg=bt_color).place(x=1040, y=15)
                        ...
                        def con():
                            ...
                            try:
                                ...
                                if conn is not None and conn.is_connected():
                                    ...
                                    c_des()
                        con() 
                    connection = mysql.connector.connect(user ="root", host="localhost",database="cargoproject",password="Prathik@2001")
                    cursor = connection.cursor()
                ...
                def emp():
                    ...
                    def emp_get():
                        ...
                        try:
                           conn = mysql.connector.connect(host ="localhost",user="root",database="cargoproject",password="Prathik@2001")
                           cursor = conn.cursor()
                           a= e_ssn.get()
                           b= e_name.get()
                           c = e_mail.get()
